...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty(trim($_POST["discount"])) && trim($_POST["discount"]) != 0 ){
        $discount_err = "* Vui lòng điền giảm giá.";
    ...
    if(empty($category_id_err) && empty($brand_id_err) && empty($name_err) && empty($description_err) && empty($image_url_err) && empty($price_err) && empty($discount_err) && empty($quantity_err) ){
        ...
        $sql = "UPDATE sanpham SET category_id= $category_id, brand_id = $brand_id, name='$name', description='$description', image_url='$image_url', price= $price, discount=$discount, quantity=$quantity WHERE id= $id";
...
<div class="row">
    <div class="col-md-12">
        ...
        <p>Điền thông tin để cập nhật sản phẩm.</p>
        ...
        <form style="display: flex; flex-direction: column;"
            ...
            <div style="display: flex;">
                ...
                <div style="flex: 3;margin-top: -32px;">
