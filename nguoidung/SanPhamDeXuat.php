    ...
    <div class="recommended_items">
        ...
        <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <?php
            $so_luong_anh = count($recommended_product[0]);
            ...
            for ($i = 0; $i < $so_luong_div; $i++) {
                ...
                while ($j < 4 && $so_luong_anh > 0) { 
                    $arr_danhgia = getCommentProduct($conn, $recommended_product[0][$i * 4 + $j]);
                    ?>
                <div class="col-sm-3">
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                ...
                                <a
                                    href="index.php?page_layout=ChiTietSanPham&id=<?= $recommended_product[0][$i * 4 + $j] ?>"><img
                                        src="./assets/images/sanpham/<?= (explode(",", $recommended_product[2][$i * 4 + $j]))[0] ?>"
                                        alt="" /></a>

                                <p style="margin-top: 10px">Mã sản phẩm: <?=  $recommended_product[0][$i * 4 + $j] ?>
                                </p>
                                ...
                                <p
                                    ...
                                    <?= $recommended_product[1][$i * 4 + $j] ?></p>


                                <?php 
                                    if($recommended_product[4][$i * 4 + $j] == 0){ ?>
                                <a
                                    href="index.php?page_layout=ChiTietSanPham&id=<?= $recommended_product[0][$i * 4 + $j] ?>">
                                    <h2 style="margin-top: 20px ; margin-bottom: 20px;">
                                        <?= number_format($recommended_product[3][$i * 4 + $j]). " VNĐ" ?>
                                    </h2>
                                </a>
                                <?php }else{ ?>
                                ...
                                <a
                                    ...
                                    <h2 style="margin-top: 10px; margin-bottom: 0px;">
                                        <?= number_format($recommended_product[4][$i * 4 + $j]). " VNĐ" ?>
                                    </h2>
                                </a>

                                <p>Giá gốc:
                                    <del><?= number_format($recommended_product[3][$i * 4 + $j]). " VNĐ" ?></del>
                                </p>
                                ...
                                <a href="index.php?page_layout=ThemVaoGioHang&id=<?= $recommended_product[0][$i * 4 + $j] ?>"
